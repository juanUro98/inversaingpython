    ...
    if opcion == "1":  # Agregar un helado
        ...
        if len(heladoos) == 0:  # Error: variable incorrecta
            ...
            for helado in heladoos:
                print(f"ID: {helado['id']}, Nombre: {helado['nombre']}, Descripción: {helado['descripcion']}, Precio: ${helado['precio']}")  # Error en claves del diccionario, variable descripcion incorrecta.
        ...
        if id_eliminar.isdigit():
            ...
            for helado in heladoos:
                if helado["id"] == id_eliminar:
                    heladoos.remove(helado)  # Error: variable incorrecta
